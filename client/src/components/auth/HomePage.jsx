...
const HomePage = () => {
    ...
    return (
        <div className="blood_banner">
            ...
            <p className="blood_banner_description">Welcome to <b className='description_b'>HopeGivers</b>, a life-saving initiative that bridges the gap between voluntary blood donors and those in urgent need of blood. Whether you're here to donate blood or find a donor, our platform makes the process simple, fast, and secure. <br /> <br /> With a growing network of committed donors across cities, we aim to ensure no life is lost due to a lack of blood. Join our mission to make blood accessible to everyone—anytime, anywhere.</p>
        </div>
    );
}
