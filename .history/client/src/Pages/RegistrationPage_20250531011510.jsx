...
import '../styles./RegistrationForm.css'; // Make sure your CSS is imported
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
        ...
        <button type="button" onClick={generateCaptcha} style={{ padding: '6px 10px', cursor: 'pointer' }}>
          ↻ Refresh
        </button>
      </div>
      ...
      <input
        ...
        required
      />
      {captchaError && <p style={{ color: 'red' }}>Captcha does not match. Please try again.</p>}
      ...
      <label>
        <input
          ...
          required
        />
        I authorise this website to display my name and telephone number, so that the needy could contact me in an emergency.
      </label>
