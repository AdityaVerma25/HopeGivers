  ...
  return (
    <div className="container">
      ...
      <header className="hero">
        ...
        <button className="primary-btn" onClick={() => navigate("/")}>Become a Donor</button>
      </header>
      ...
      <section className="cta">
        ...
        <button className="primary-btn" onClick={() => navigate("/registrationform/donor")}>Register Now</button>
      </section>
